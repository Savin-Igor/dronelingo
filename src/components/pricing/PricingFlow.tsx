    ...
    <div className="mx-auto max-w-lg">
      ...
      <div className="rounded-sm border border-horizon bg-cockpit p-6">
        ...
        <ul className="mt-4 space-y-2.5">
          {FEATURES.map((f) => (
            <li key={f} className="flex items-start gap-2.5 text-sm text-telemetry">
      ...
      {/* Payment */}
      <div className="mt-4 rounded-sm border border-horizon bg-cockpit p-6">
        <h2 className="font-mono text-xs uppercase tracking-widest text-cyan-pulse">
          One-time payment
        </h2>
        ...
        <div className="mt-4 flex items-center justify-between rounded-sm border border-horizon bg-hull px-4 py-3">
          ...
          <span className="font-mono text-xl font-semibold text-hud-white">€19</span>
        </div>
